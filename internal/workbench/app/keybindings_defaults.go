...
var defaultDefs = []commandDef{
	...
	{id: "query.complete", scope: scopeEditor, keys: []string{"ctrl+space"}, label: "complete"},
	...
	{id: "browse.add_table", scope: scopeView, keys: []string{"a"}, label: "add table"},
	{id: "browse.rename_table", scope: scopeView, keys: []string{"e"}, label: "edit table"},
	{id: "browse.delete_table", scope: scopeView, keys: []string{"d"}, label: "delete table"},
