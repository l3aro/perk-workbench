...
func TestCommandPalette_connectionShowsExecutableCommands(t *testing.T) {
	...
	assertCommandIDs(t, newCommandPalette(model), "app.quit", "appearance.select", "appearance.toggle", "connection.add", "connection.delete", "connection.edit", "connection.switch_to_form", "notifications.show", "plugin.manage", "table.open_target", "theme.select", "vim.toggle")

	model.connection.component.Form.Focus = connectionFocusForm
	assertCommandIDs(t, newCommandPalette(model), "app.quit", "appearance.select", "appearance.toggle", "connection.edit_field", "connection.execute", "connection.field_next", "connection.field_prev", "connection.switch_to_list", "editor.external", "notifications.show", "plugin.manage", "table.open_target", "theme.select", "vim.toggle")
}
