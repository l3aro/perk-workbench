...
func ColumnTypes(info DatabaseInfo) []ColumnType {
	...
	if info.Product == "MySQL" {
		...
		return []ColumnType{
			{Name: "TINYINT", Attributes: autoIncrement}, {Name: "TINYINT UNSIGNED", Attributes: autoIncrement},
			{Name: "SMALLINT", Attributes: autoIncrement}, {Name: "SMALLINT UNSIGNED", Attributes: autoIncrement},
			{Name: "MEDIUMINT", Attributes: autoIncrement}, {Name: "MEDIUMINT UNSIGNED", Attributes: autoIncrement},
			{Name: "INT", Attributes: autoIncrement}, {Name: "INT UNSIGNED", Attributes: autoIncrement},
			{Name: "BIGINT", Attributes: autoIncrement}, {Name: "BIGINT UNSIGNED", Attributes: autoIncrement},
	...
	if info.Product == "PostgreSQL" {
		...
		return []ColumnType{
			{Name: "SMALLINT", Attributes: identity}, {Name: "INTEGER", Attributes: identity}, {Name: "BIGINT", Attributes: identity},
